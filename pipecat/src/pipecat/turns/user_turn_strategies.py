...
class ExternalUserTurnStrategies(UserTurnStrategies):
    ...
    Parameters:
        enable_interruptions: Whether to broadcast an interruption when a
            ...
            setting here.
        wait_for_transcript: Whether turn stop waits for a final transcript.
            Set False when the external source finalizes all transcription
            before proposing a stop, including turns with no recognized words.
    ...
    def __post_init__(self):
        ...
        self.stop = [ExternalUserTurnStopStrategy(wait_for_transcript=self.wait_for_transcript)]
